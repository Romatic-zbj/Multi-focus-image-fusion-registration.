...
class LpLssimLoss(nn.Module):
    ...
    def forward(self, image_in, image_out):
        ...
        return Lp * 20 + Lssim * 80, Lp * 20, Lssim * 80
if __name__ == '__main__':
    x = torch.randn(1,1,520,520)
    y = torch.randn(1,1,520,520)
    criterion = LpLssimLoss()
    loss, lp_loss, lssim_loss = criterion(image_in=x, image_out=y)
    print(loss)
