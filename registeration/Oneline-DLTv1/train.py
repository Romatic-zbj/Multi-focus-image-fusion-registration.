...
# name of log
train_log_dir = 'train_log_OnelineMF_0524-FastDLT'
...
def train(args):
    ...
    train_path = os.path.join(exp_name, 'Data/trainMicro_01.txt')
    ...
    train_loader = DataLoader(dataset=train_data, batch_size=args.batch_size, num_workers=args.cpus, shuffle=True, drop_last=False)
    ...
    for epoch in range(args.max_epoch):
        ...
        for i, batch_value in enumerate(train_loader):
            ...
            org_imges = batch_value[0].float()#读取到的值
